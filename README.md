# [SOLVED] Psql-Error-Connection-To-Server-On-Socket-Quot-Tmp-S-Pgsql-5
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/psql-error-connection-to-server-on-socket-quot-tmp-s-pgsql-5)
>
...
Try resetting the PostgreSQL socket directory by running `brew link postgresql --overwrite` and then try connecting again.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/psql-error-connection-to-server-on-socket-quot-tmp-s-pgsql-5)**
